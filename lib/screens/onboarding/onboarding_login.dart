...
class OnboardingLogin extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OnboardingScaffold(
      header: 'Log in',
      subtitle:
          'Glacier needs your permission in order to enable the ability to chat, view followed streams, and more.',
      disclaimer:
          'Glacier only asks for the necessary permissions through the official Twitch API. You\'ll be able to review them before authorizing.',
